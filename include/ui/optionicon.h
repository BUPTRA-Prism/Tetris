...
public:
     ...
     */
    OptionIcon(Context& ctx, SDL_Texture* texture, std::function<SDL_Point(int, int)> func, int m_showFrameTarget, int m_hideFrameTarget);
     ...
     */
    void onRender(int row, int col, bool isFlip = false);
};