...
OptionIcon::OptionIcon(Context& ctx, SDL_Texture* texture, std::function<SDL_Point(int, int)> func, int m_showFrameTarget, int m_hideFrameTarget)
    : m_ctx(ctx)
    , m_texture(texture)
    , m_func(func)
...
void OptionIcon::onRender(int row, int col, bool isFlip) {
